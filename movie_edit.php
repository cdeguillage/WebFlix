<?php
    ...
    if (!empty($_GET)) {
        ...
        $cover['name'] = $movie['cover'];
        $filename_saved = $movie['cover'];
        $released_at = substr($movie['released_at'], 0, 10);
    ...
    if (!empty($_POST)) {
        ...
        {
            $errors['video_link'] = 'Le lien vers la vidéo n\'est pas valide';
        }
        ...
        {
            // $errors['cover'] = 'La pochette n\'est pas sélectionné';
    ...
    <main class="container">
        ...
        <?php if (isset($primary) && $primary) { ?>
            <div class="alert alert-primary alert-dismissible fade show">
                Le film <strong><?php echo $title; ?></strong> a bien été modifié avec l'id <strong><?php echo $id; ?></strong> !
            ...
            <div class='card-body bg-white'>
                <div class="row">
                            ...
                            <div class="row">
                                <div class="col-10">
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <small class="text-right text-muted"><?php echo empty($cover) ? '' : $cover['name']; ?></small>
                                        </div>
                                    </div>
                                ...
                                <div class="col-2">
                                    <img class="img-pochette" src="<?php echo empty($cover) ? '' : $cover['name']; ?>" alt="Pochette" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        ...
                        <button type="submit" class="btn btn-primary btn-block text-uppercase">Modifier</button>
                    </div>
                </div><!-- /.row -->
            </div><!-- /.card-body -->
        </form>
